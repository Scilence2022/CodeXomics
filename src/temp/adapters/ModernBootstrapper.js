...
class ModernBootstrapper {
  ...
  async setupCompatibilityLayer(legacyGenomeBrowser) {
    ...
    this.compatibilityAdapter = new LegacyCompatibilityAdapter(this.context, legacyGenomeBrowser);
  ...
  async registerCoreCommands() {
    ...
    const migrateModuleCommand = new Command('migration:migrateModule', this.migrateModuleHandler.bind(this), {
    ...
    const rollbackCommand = new Command('migration:rollback', this.rollbackModuleHandler.bind(this), {
