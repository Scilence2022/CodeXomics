            ...
            inputSchema: {
              ...
              properties: {
                ...
                includeMatchSequence: {
                  type: 'boolean',
                  description: 'Include matched sequence regions',
                  default: true,
                },
              },
              required: ['sequence'],
          ...
          },
          {
            ...
            inputSchema: {
              ...
              properties: {
                ...
                constraints: {
                  type: 'object',
                  description: 'Optimization constraints (GC content, codon usage, etc.)',
                },
          ...
          },
          {
            ...
            inputSchema: {
              ...
              properties: {
                ...
                organism: {
                  type: 'string',
                  description: 'Organism name for comparison (optional)',
                  default: 'E. coli',
                },
