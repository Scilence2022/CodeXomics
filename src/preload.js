...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  checkFilesExist: filePaths => ipcRenderer.invoke('checkFilesExist', filePaths),
  openFileInExternalEditor: filePath => ipcRenderer.invoke('openFileInExternalEditor', filePath),
