    ...
    getTools() {
        return {
            ...
            get_track_settings: {
                ...
                description: 'Get current settings for a specific track type (genes, reads, sequence, gc, variants, actions, blast, wigTracks, sequenceLine)',
                parameters: {
                    type: 'object',
                    properties: {
                        track_type: {
                ...
                parameters: {
                    ...
                    properties: {
                        track_type: {
                            ...
                            enum: ['genes', 'reads', 'sequence', 'gc', 'variants', 'actions', 'blast', 'wigTracks', 'sequenceLine', 'all']
                        }
                    },
                    required: ['track_type']
                }
