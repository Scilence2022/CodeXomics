...
// Display versions
const VERSION_DISPLAY = VERSION_PRERELEASE ? `v${VERSION_MAJOR}.${VERSION_MINOR}${VERSION_PRERELEASE}` : `v${VERSION_MAJOR}.${VERSION_MINOR}`;
const VERSION_DISPLAY_FULL = VERSION_DISPLAY;
