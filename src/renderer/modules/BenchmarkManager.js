...
class BenchmarkManager {
  ...
  async loadTestSuites() {
    const suites = ['AutomaticSimpleSuite', 'AutomaticComplexSuite', 'ManualSuite'];
  ...
  getBenchmarkStatistics() {
    ...
    return {
      ...
      averageSuccessRate:
        history.reduce((sum, result) => sum + result.overallStats.overallSuccessRate, 0) / history.length,
    };
  }
