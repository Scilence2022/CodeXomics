...
class ExtensionService {
    ...
    constructor(options = {}) {
        ...
        this._activationService.setActivationHandler(
            this._handleActivation.bind(this)
        );
    ...
    _registerBuiltinCommands() {
        ...
        this._commandRegistry.registerCommand('extension.list', () => {
        ...
        this._commandRegistry.registerCommand('extension.activate', async (extensionId) => {
        ...
        this._commandRegistry.registerCommand('extension.deactivate', async (extensionId) => {
        ...
        this._commandRegistry.registerCommand('extension.reload', async (extensionId) => {
    ...
    _registerContributedCommands(extensionId, commands) {
        for (const cmd of commands) {
            ...
            this._commandRegistry.registerCommand(cmd.command, async (...args) => {
     ...
     */
    getStats() {
        const activeCount = Array.from(this._extensions.values())
