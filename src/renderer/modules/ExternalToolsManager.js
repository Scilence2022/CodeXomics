  ...
  async saveAllSettings() {
    try {
      ...
      if (this.genomeBrowser.configManager) {
        ...
        await this.genomeBrowser.configManager.set(
          'generalSettings.deepGeneResearchUrl',
          this.builtinTools.deepGeneResearch.url
        );
        ...
        if (this.genomeBrowser.generalSettingsManager) {
          this.genomeBrowser.generalSettingsManager.updateSetting(
            'deepGeneResearchUrl',
            this.builtinTools.deepGeneResearch.url
          );
