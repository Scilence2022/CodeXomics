...
class PluginMarketplaceUI {
  ...
  async loadPluginList() {
    ...
    try {
      ...
      if (plugins.length === 0) {
        const noResultsMessage = searchQuery ? `No plugins found for "${searchQuery}"` : 'No plugins available';
                    ...
                    <div style="text-align: center; padding: 40px; color: #666;">
                        ...
                        <p>${
                          searchQuery
                            ...
                            : 'Check your marketplace server connection or submit the first plugin!'
                        }</p>
                        ${
                          searchQuery
                            ? `<button onclick="pluginMarketplaceUI.clearSearch()" 
