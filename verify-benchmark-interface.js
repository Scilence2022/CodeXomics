...
console.log('1. Click the "Benchmark & Debug Tools" button in the Options menu');
...
console.log('');
console.log('Note: Benchmark functionality was moved from Tools menu to Benchmark & Debug Tools');
