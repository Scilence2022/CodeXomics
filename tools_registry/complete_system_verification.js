...
async function runCompleteVerification() {
  ...
  try {
    ...
    console.log(
      `   - Built-in Tool Usage: ${diagnostics.system_info.usage_stats.execution_history.builtin_tool_usage}`
    );
    console.log(
      `   - External Tool Usage: ${diagnostics.system_info.usage_stats.execution_history.external_tool_usage}`
    );
