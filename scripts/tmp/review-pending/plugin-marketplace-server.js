...
async function initializeSamplePlugins() {
  const samplePlugins = {
    ...
    'rna-seq-analyzer': {
      ...
      screenshots: ['https://example.com/screenshots/rna-seq-1.png', 'https://example.com/screenshots/rna-seq-2.png'],
      rating: 4.6,
      downloads: 12234,
    ...
    'phylogenetic-tree-builder': {
      ...
      screenshots: ['https://example.com/screenshots/phylo-1.png'],
      rating: 4.8,
      downloads: 6789,
