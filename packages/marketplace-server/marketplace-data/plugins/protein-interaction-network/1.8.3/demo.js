...
class ProteinNetworkDemo {
        ...
        return {
            ...
            complex: {
                ...
                networkData: {
                    ...
                    edges: [
                        { source: 'ATM', target: 'TP53', confidence: 0.90, type: 'activation' },
                        ...
                        { source: 'ATR', target: 'CHEK2', confidence: 0.80, type: 'activation' },
            ...
            oncogene: {
                ...
                networkData: {
                    ...
                    edges: [
                        ...
                        { source: 'BRCA1', target: 'TP53', confidence: 0.90, type: 'interaction' },
    ...
    generateLargeNetwork() {
        const proteins = [
            ...
            'CHEK1', 'CHEK2', 'MDM2', 'MDM4', 'CDKN1A',
            'PTEN', 'AKT1', 'KRAS', 'BRAF', 'EGFR'
        ];
        ...
        for (let i = 0; i < proteins.length; i++) {
            for (let j = i + 1; j < proteins.length; j++) {
                ...
                if (Math.random() > 0.65) {  // ~35% connectivity
                    edges.push({
                        source: proteins[i],
                        target: proteins[j],
    ...
    validateResult(result, networkData, rules) {
        ...
        if (rules.minAvgConfidence && networkData.edges.length > 0) {
            const avgConfidence = networkData.edges.reduce((sum, e) => sum + (e.confidence || 0), 0) / networkData.edges.length;
