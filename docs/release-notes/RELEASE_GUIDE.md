# 🚀 Release Guide for CodeXomics v0.532beta

## ✅ Release Status: READY

All preparations for the v0.532beta release have been completed successfully!
...
- **Tag:** `v0.532beta`
- **Commit:** `00265a7`
- **Message:** "Release v0.532beta - Beta release with ProGenFixer integration and improved LLM model organization"
- **Status:** ✅ Pushed to GitHub

### ✓ Documentation Created

- **CHANGELOG.md** - Permanent changelog for the project
- **RELEASE_NOTES_v0.532beta.md** - Detailed release notes for this version
...
- ✅ `CodeXomics-0.532.0-beta-x64.dmg` (139 MB) - Intel Mac
- ✅ `CodeXomics-0.532.0-beta-arm64.dmg` (134 MB) - Apple Silicon
- ✅ `CodeXomics-0.532.0-beta-mac.zip` (133 MB) - Universal zip
- ✅ `CodeXomics-0.532.0-beta-arm64-mac.zip` (129 MB) - ARM64 zip

#### Windows

- ✅ `CodeXomics Setup 0.532.0-beta.exe` (207 MB) - Installer
- ✅ `CodeXomics 0.532.0-beta.exe` (207 MB) - Portable

#### Linux

- ✅ `CodeXomics-0.532.0-beta.AppImage` (144 MB) - AppImage
- ✅ `codexomics_0.532.0-beta_amd64.deb` (93 MB) - Debian package
- ✅ `codexomics_0.532.0-beta_amd64.snap` (124 MB) - Snap package

**Location:** `/Users/song/Github-Repos/CodeXomics/dist/`
...
**Choose a tag:** Select `v0.532beta` from the dropdown (it's already pushed)

**Release title:**

```
CodeXomics v0.532beta - Beta Release
```

**Release description:** Copy the content from `RELEASE_NOTES_v0.532beta.md` file, or use this:

```markdown
# CodeXomics v0.532beta Release Notes
...
- Updated version display to show beta designation: **v0.532beta**
...
- **Intel (x64):** CodeXomics-0.532.0-beta-x64.dmg
- **Apple Silicon (arm64):** CodeXomics-0.532.0-beta-arm64.dmg

### Windows

- **Installer:** CodeXomics Setup 0.532.0-beta.exe
- **Portable:** CodeXomics 0.532.0-beta.exe

### Linux

- **AppImage:** CodeXomics-0.532.0-beta.AppImage
- **Debian:** codexomics_0.532.0-beta_amd64.deb
- **Snap:** codexomics_0.532.0-beta_amd64.snap
...
- `CodeXomics-0.532.0-beta-x64.dmg`
- `CodeXomics-0.532.0-beta-arm64.dmg`
- `CodeXomics-0.532.0-beta-mac.zip`
- `CodeXomics-0.532.0-beta-arm64-mac.zip`

**Windows:**

- `CodeXomics Setup 0.532.0-beta.exe`
- `CodeXomics 0.532.0-beta.exe`

**Linux:**

- `CodeXomics-0.532.0-beta.AppImage`
- `codexomics_0.532.0-beta_amd64.deb`
- `codexomics_0.532.0-beta_amd64.snap`
...
gh release create v0.532beta \
  dist/CodeXomics-0.532.0-beta-x64.dmg \
  dist/CodeXomics-0.532.0-beta-arm64.dmg \
  dist/CodeXomics-0.532.0-beta-mac.zip \
  dist/CodeXomics-0.532.0-beta-arm64-mac.zip \
  "dist/CodeXomics Setup 0.532.0-beta.exe" \
  "dist/CodeXomics 0.532.0-beta.exe" \
  dist/CodeXomics-0.532.0-beta.AppImage \
  dist/codexomics_0.532.0-beta_amd64.deb \
  dist/codexomics_0.532.0-beta_amd64.snap \
  --title "CodeXomics v0.532beta - Beta Release" \
  --notes-file RELEASE_NOTES_v0.532beta.md \
  --prerelease
```
