...
├── developer-guides/         # Developer docs (8 files)
├── user-guides/              # User docs (6 files)
├── reference/                # Reference guides (7 files)
├── release-notes/            # Version history (2 files)
├── troubleshooting/          # Issue fixes (5 files)
├── proposals/                # Future features (2 files)
└── _archive/                 # Historical docs (291 files)
```
...
- [Release Guide](release-notes/RELEASE_GUIDE.md) - Release procedures
- [v0.522beta Notes](release-notes/RELEASE_NOTES_v0.522beta.md) - Previous release
...
**Need Help?** Start with the [User Guide](user-guides/USER_GUIDE.md) or ask in [GitHub Discussions](https://github.com/Scilence2022/CodeXomics/discussions).
